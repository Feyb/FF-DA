...
export const NFL_CAPITAL_MULT: Record<NflPosition, Record<NflDraftRound, number>> = {
  WR: { 1: 1.25, 2: 1.15, 3: 0.95, 4: 0.85, 5: 0.75, 6: 0.72, 7: 0.70, 8: 0.70 },
  RB: { 1: 1.25, 2: 1.12, 3: 0.90, 4: 0.75, 5: 0.75, 6: 0.72, 7: 0.70, 8: 0.70 },
  TE: { 1: 1.25, 2: 1.10, 3: 0.85, 4: 0.78, 5: 0.72, 6: 0.70, 7: 0.70, 8: 0.70 },
  QB: { 1: 1.30, 2: 1.00, 3: 0.80, 4: 0.72, 5: 0.70, 6: 0.70, 7: 0.70, 8: 0.70 },
};
